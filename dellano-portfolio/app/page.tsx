            ...
            >
              ...
              >
                ...
                <div style={{ marginTop: "auto", paddingTop: "0.5rem" }}>
                  <a
                    href="https://github.com/Dellano23/gestaoEnergia"
                    target="_blank"
                    rel="noopener noreferrer"
              ...
              >
                ...
                >
                  Desenvolvimento de uma aplicação de artigos/newsletter focados
                  na área tech. Frontend em Next.js 16 e React 19, integrando um
                  backend em Node.js conectado ao PostgreSQL.
                  <br></br>
                  Frontend: UI responsiva com navegação por seções, animações
                  sutis.
                  <br></br>
                  Arquitetura: Backend em Node.js consumindo dados do
                  PostgreSQL, com camada de banco estruturada e migrações
                  gerenciadas pela ferramenta node-pg-migrate para criar,
                  alterar e controlar o histórico da estrutura (esquema) do
                  banco de dados.
                  <br></br>
                  Testes: Cobertura com Jest para endpoints e validações de
                  integração. Desenvolvimento foi feito baseado em testes.
                  <br></br>
                  Infraestrutura & DevOps: ambiente local orquestrado com Docker
                  Compose, banco PostgreSQL em container e deploy contínuo
                  planejado para Vercel.
                  <br></br>
                ...
                <div style={{ marginTop: "auto", paddingTop: "0.5rem" }}>
                  <a
                    href="https://github.com/Dellano23/postnews"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="project-arrow"
                  >
              ...
              >
                ...
                <div style={{ marginTop: "auto", paddingTop: "0.5rem" }}>
                  <a
                    href="https://github.com/Dellano23/EnergyApi"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="project-arrow"
                  >
